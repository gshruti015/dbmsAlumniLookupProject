...
try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
       ...
       $stmt = $conn->prepare("SELECT ALMFNAME, ALMLNAME, COMNAME FROM SMITH_ALL WHERE INDUSTRY = 'CONSULTING'"); 
       $stmt->execute();
    ...
    echo "<tr style='border-collapse:collapse;border: 1pt solid black;padding-top: 12px;padding-bottom: 12px;text-align: center;background-color: #b6b6ff; color: white;'><th>First Name</th><th>Last Name</th><th>Company Name</th></tr>";
